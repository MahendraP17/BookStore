...
export default function Banner() {
    return (
        <div className="relative mt-0 md:mt-0 w-full bg-base-100 flex flex-col md:flex-row px-5 md:px-20 overflow-hidden my-10  dark:bg-slate-900 dark:-white">
            {/* Left Section */}
            <div className="w-full order-2 md:order-1 md:w-1/2 mt-6 md:mt-24">  {/* Added mt-6 for small devices */}
                <div className="space-y-6">
                    ...
                    <p className="text-xl">
                        ...
                        sequi consectetur rem culpa, quis nulla dolorum accusamus ipsum ratione saepe ab commodi,
                        aliquid aspernatur architecto.
                    </p>
                    {/* Email Input */}
                    <label className="input validator flex items-center border rounded-md px-3 py-2 ">
                        ...
                        <input type="email" placeholder="mail@site.com" required className="outline-none w-full bg-transparent dark:text-black" />
                    </label>
            ...
            {/* Right Section */}
            <div className="order-1 w-full md:w-1/2 flex justify-center mt-18 md:mt-24 ">  {/* Added mt-6 for spacing on small devices */}
                <img src={banner} className="w-full md:w-auto md:h-full rounded-4xl object-cover" alt="Banner" />
            </div>
        </div>
    );
}
